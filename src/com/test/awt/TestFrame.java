...
public class TestFrame extends JFrame {
	...
	private double operator(double operA, int i, String str) {
		double operB = i == signpos.size() - 1 ? Double.parseDouble(str.substring(signpos.get(i) + 1)) : Double
				.parseDouble(str.substring(signpos.get(i) + 1, signpos.get(i + 1)));
	...
	public static void main(String[] args) {
		TestFrame mf = new TestFrame("计算器");
		mf.setVisible(true);
	}
}
